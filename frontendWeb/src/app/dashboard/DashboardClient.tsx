...
import { Building2, Calendar, CheckCircle, Clock, DollarSign, TrendingUp, Users } from "lucide-react";
import {
  BarChart,
  Bar,
  XAxis,
...
export function DashboardClient({ stats, t, locale }: DashboardClientProps) {
  ...
  const bookingStatusData = [
    ...
    { name: t["dashboard.cancelled"], value: stats?.cancelledBookings || 0, color: '#ef4444' },
  ];
  ...
  const monthlyData = [
    ...
    { month: 'May', bookings: 32, revenue: 6400 },
    { month: 'Jun', bookings: 28, revenue: 5600 },
  ];
