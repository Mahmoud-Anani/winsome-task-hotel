...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "dashboard.bookingStatus": "Booking Status",
    ...
    "hotels.detail.startingFrom": "Starting from",
    "hotels.detail.bookNow": "Book Now",
    "hotels.detail.bookRoom": "Book Room",
    "hotels.detail.totalBookings": "Total Bookings",
    "hotels.detail.totalRooms": "Total Rooms",
    "hotels.detail.availableRoomsCount": "Available",
    "hotels.detail.amenities": "Amenities",
    "hotels.detail.location": "Location",
    "bookings.title": "Bookings",
    "bookings.subtitle": "Manage your reservations",
    ...
    "bookings.guestCount": "Guest Count",
    "bookings.confirm": "Confirm",
    "bookings.cancel": "Cancel",
    "bookings.pay": "Pay",
    "bookings.payment.estimate": "Estimated payment",
    ...
    "bookings.create.title": "Create New Booking",
    "bookings.create.button": "Create Booking",
    "bookings.creating": "Creating...",
    "validation.hotelRequired": "Please select a hotel",
    "validation.roomRequired": "Please select a room",
  ...
  ar: {
    ...
    "hotels.detail.startingFrom": "يبدأ من",
    "hotels.detail.bookNow": "احجز الآن",
    "hotels.detail.bookRoom": "احجز الغرفة",
    "hotels.detail.totalBookings": "إجمالي الحجوزات",
    "hotels.detail.totalRooms": "إجمالي الغرف",
    "hotels.detail.availableRoomsCount": "متاح",
    "hotels.detail.amenities": "المرافق",
    "hotels.detail.location": "الموقع",
    "bookings.title": "الحجوزات",
    "bookings.subtitle": "إدارة حجوزاتك",
    ...
    "bookings.selectRoom": "اختر غرفة",
    "bookings.guestCount": "عدد الضيوف",
    ...
    "bookings.pay": "ادفع",
    "bookings.payment.estimate": "المبلغ المتوقع",
    "bookings.nights": "ليالي",
    "bookings.create.title": "إنشاء حجز جديد",
    "bookings.create.button": "إنشاء الحجز",
    "bookings.creating": "جاري الإنشاء...",
    "validation.hotelRequired": "يرجى اختيار فندق",
    "validation.roomRequired": "يرجى اختيار غرفة",
